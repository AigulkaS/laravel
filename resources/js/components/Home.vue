...
<!--                        Временно-->
                        <div v-if="auth_user.role_id == 1" class="alert alert-primary">
                            Руководителю вашей больницы на почтовый адрес направлено письмо для прикрепления вам роли (хирург/кардиолог).
                            После того как вам назначат роль вам на почтовый адрес придет сообщение.
                        </div>
                    </div>
